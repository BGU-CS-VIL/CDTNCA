...
class Cpab(object):
    ...
    def __init__(self, 
        ...
        self.params.circularity = 1 if circularity else 0
        ...
        self.tesselation = tesselation(self.params.nc, self.params.domain_min, 
                                       ...
                                       self.params.volume_perservation, self.params.circularity,
                                       self._dir, override)
        ...
        if self.backend_name == 'numpy':
            from .numpya import functions as backend
        elif self.backend_name == 'tensorflow':
            from .tensorflowa import functions as backend
