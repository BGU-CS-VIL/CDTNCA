...
at::Tensor cpab_cuda_forward(at::Tensor points_in, at::Tensor trels_in,  
							 ...
							 const int broadcast, at::Tensor output, const int* circularity);
at::Tensor cpab_cuda_backward(at::Tensor points_in, at::Tensor As_in, 
                              at::Tensor Bs_in, at::Tensor nstepsolver_in,
                              at::Tensor nc, const int broadcast, at::Tensor output, const int* circularity);
...
at::Tensor cpab_forward(at::Tensor points_in, //[ndim, n_points] or [batch_size, ndim, n_points]
                        ...
                        at::Tensor circularity){ //circularity constraint
    // Do input checking
    ...
    const int* circ = circularity.data<int>();
//    const int circ = 1;
    // Allocate output
